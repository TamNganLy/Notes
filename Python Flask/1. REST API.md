...
4. Install the Flask library
    ...
    pip install flask
    ```
    ✔ Check if the Flask package exists in the `.venv` folder after installation.
...
### 2️⃣ Create a GET route with dynamic URL
```python
...
### 4️⃣ Create a POST route with dynamic URL
```python
